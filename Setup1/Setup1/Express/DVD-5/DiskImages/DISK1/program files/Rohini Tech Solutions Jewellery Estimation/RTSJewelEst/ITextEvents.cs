...
namespace RTSJewelERP
{
    public class ITextEvents : PdfPageEventHelper
    {
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            Font headerFONT = new Font(Font.FontFamily.HELVETICA, 14f, Font.BOLD, BaseColor.RED);
            Font allFONTsize = new Font(Font.FontFamily.TIMES_ROMAN, 8f, Font.NORMAL, BaseColor.BLACK);
            Font tinfont = new Font(Font.FontFamily.TIMES_ROMAN, 7f, Font.NORMAL, BaseColor.BLACK);
            ...
            Phrase pht1 = new Phrase("GSTIN: 33AFWPR5889R1ZV" + "\n", tinfont);

            Font chunkguru = new Font(Font.FontFamily.TIMES_ROMAN, 7f, Font.BOLDITALIC, BaseColor.BLACK);
           ...
           firmtitletable.DefaultCell.Border = 0;
            ...
            {
                Phrase pfirm1CashCredit = new Phrase("Tax Invoice" + "\n", gstInv);
                p11.Add(pfirm1CashCredit);
            }
            ...
            dateInvoice.DefaultCell.HorizontalAlignment = Element.ALIGN_LEFT;
            //PdfPCell FirmTitCell = new PdfPCell();

            iTextSharp.text.Paragraph dtinv = new iTextSharp.text.Paragraph();

            Phrase pdtInv = new Phrase("Date: " + BillDate + "  " + "Invoice: " + invFormatDigit + "", chunkguru);
            dtinv.Add(pdtInv);
            ...
            if (CashCustName == "")
            {
                ...
                Phrase phpcust1 = new Phrase("Delivery By: " + SelectedValueDelivery + "-" + transportName + "\n", allFONTsize);
                p3.Add(phpcust1);
            ...
            float[] widthsTab = new float[] { 195, 195 };
           ...
           // float balancehght = 157 - Firmdatetable.TotalHeight;
            float balancehght = 155 - Firmdatetable.TotalHeight;

            if (balancehght >= pdfTab.TotalHeight +2)
            {
