...
{
    public class ITextEventsCRDRNote : PdfPageEventHelper
    {
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            // String text = "     Page " + writer.PageNumber +"                                                   **This is Computer Generated Invoice**                                     Authorised Signatory ";
             String text = "     Page " + writer.PageNumber + "                                                   **This is Computer Generated Credit Note**                                                           ";
           ...
           firmtitletable.DefaultCell.Border = 0;
            ...
            if (CashCustName != "")
            {
                Phrase pfirm1CashCredit = new Phrase("Credit Note" + "\n", gstInv);
            ...
            Phrase pdtInv = new Phrase("Date: " + BillDate + "  " + "Credit Note#: " + invFormatDigit + " " + " Your Ref No#: " + EwayNumber + "", chunkguru);
            dtinv.Add(pdtInv);
